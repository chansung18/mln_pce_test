...
/**
 * RRO의 SubObject 중 하나로, SLU를 저장하는 서브정보객체.
 * 
 * @author Ancom
 * 
 */
public class RROSLU extends RROSubObj {

	private int routerID;
	private int interfaceID;

	public RROSLU(boolean l, byte messageType, byte length) {
	...
	public RROSLU(boolean l, byte messageType, byte length, byte[] data) {
	...
	public RROSLU(byte[] data) {
		super(data);
		type = 4;
		length = 12;
	}

	public RROSLU(boolean l) {
		super(l);
		type = 4;
		length = 12;
	}
