...
/**
 * ERO의 SubObject 중 하나로, IPv6의 Prefix를 저장하는 서브정보객체.
 * 
 * @author Ancom
 * 
 */
public class EROIPv6Prefix extends EROSubObj {

	private byte[] ipv6;
	private byte prefixlength;

	public EROIPv6Prefix(boolean l, byte messageType, byte length) {
	...
	public EROIPv6Prefix(boolean l, byte messageType, byte length, byte[] data) {
	...
	public EROIPv6Prefix(byte[] data) {
		super(data);
	}
