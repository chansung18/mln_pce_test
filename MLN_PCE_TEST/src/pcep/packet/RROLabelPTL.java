...
/**
 * RRO의 SubObject 중 하나로, PTL형식의 Label을 저장하는 서브정보객체.
 * 
 * @author Ancom
 * 
 */
public class RROLabelPTL extends RROSubObj {
	private byte[] espvid;
	...
	public RROLabelPTL(boolean l, byte messageType, byte length) {
	...
	public RROLabelPTL(boolean l, byte messageType, byte length, byte[] data) {
