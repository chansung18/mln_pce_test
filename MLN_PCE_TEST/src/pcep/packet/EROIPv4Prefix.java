...
/**
 * ERO의 SubObject 중 하나로, IPv4의 Prefix를 저장하는 서브정보객체.
 * 
 * @author Ancom
 * 
 */
public class EROIPv4Prefix extends EROSubObj {

	private byte[] ipv4;
	private byte prefixlength;

	public EROIPv4Prefix(boolean l) {
		super(l);
		type = 1;
		length = 8;
		ipv4 = new byte[4];
	...
	public EROIPv4Prefix(byte[] data) {
		super(data);
	}

	public EROIPv4Prefix(boolean l, byte messageType, byte length) {
	...
	public EROIPv4Prefix(boolean l, byte messageType, byte length, byte[] data) {
