...
/**
 * XRO의 SubObject 중 하나로, IPv6의 Prefix를 저장하는 서브정보객체.
 * 
 * @author Ancom
 * 
 */
public class XROIPv6Prefix extends XROSubObj {

	private byte[] ipv6;
	private byte prefixlength;

	public XROIPv6Prefix(boolean x, byte messageType, byte length) {
	...
	public XROIPv6Prefix(boolean x, byte messageType, byte length, byte[] data) {
	...
	public XROIPv6Prefix(byte[] data) {
		super(data);
	}
