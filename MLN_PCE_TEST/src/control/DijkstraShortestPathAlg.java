...
//		Set<BaseVertex> neighbor_vertex_list = is_source2sink ? _graph.get_adjacent_vertices(vertex) : _graph.get_precedent_vertices(vertex);
		Vector<BaseVertex> neighbor_vertex_list = is_source2sink ? _graph.get_adjacent_vertices(vertex) : _graph.get_precedent_vertices(vertex);
...
//		Set<BaseVertex> adj_vertex_set = _graph.get_adjacent_vertices(vertex);
		Vector<BaseVertex> adj_vertex_set = _graph.get_adjacent_vertices(vertex);
...
//			Set<BaseVertex> pre_vertex_set = _graph.get_precedent_vertices(cur_vertex);
			Vector<BaseVertex> pre_vertex_set = _graph.get_precedent_vertices(cur_vertex);
